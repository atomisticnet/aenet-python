...
- Compatibility: Preserve feature ordering and typespin weighting consistent
  with the Fortran reference implementation.
...
- Detailed derivation (math): :doc:`angular_gradient_math`
- Chebyshev polynomials and cutoff details: ``src/aenet/torch_featurize/chebyshev.py``
- Neighbor list details: ``src/aenet/torch_featurize/neighborlist.py``
